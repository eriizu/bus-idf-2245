...
pub fn operating_flags_from_iter<'a>(
    iter: impl Iterator<Item = &'a str>,
) -> impl Iterator<Item = Runs> {
    iter.map(time_of_year_and_day_flag_from_str)
}

// pub fn operating_flags_from_iter1<'a>(iter: impl Iterator<Item = &'a str>) -> Vec<Runs> {
